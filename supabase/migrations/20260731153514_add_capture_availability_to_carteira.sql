...
declare
  ...
  v_roletas jsonb;
  v_capturas jsonb;
  v_roletas_permitidas integer := 0;
  v_roletas_ativas_captura integer := 0;
  v_oportunidades_disponiveis integer := 0;
  v_disponibilidade_captura text := 'dados_indisponiveis';
begin
  ...
  if v_perfil <> 'corretor' then
    v_disponibilidade_captura := 'perfil_sem_captura';
  elsif v_roletas_permitidas = 0 then
    v_disponibilidade_captura := 'sem_permissao_roleta';
  elsif v_roletas_ativas_captura = 0 then
    v_disponibilidade_captura := 'sem_roleta_ativa';
  elsif v_oportunidades_disponiveis = 0 then
    v_disponibilidade_captura := 'sem_oportunidades';
  else
    v_disponibilidade_captura := 'disponivel';
  end if;
  ...
  return jsonb_build_object(
    ...
    'disponibilidade_captura', v_disponibilidade_captura,
    'roletas', v_roletas,
