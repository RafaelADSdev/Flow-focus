...
- **[docs/product.md](./docs/product.md)** — register `product`, usuários (corretor, líder, diretora, admin), propósito, personalidade, anti-referências e princípios estratégicos.
- **[docs/design.md](./docs/design.md)** — tokens OKLCH, tipografia, componentes e regras visuais (Creative North Star: **A Central Silenciosa**).
